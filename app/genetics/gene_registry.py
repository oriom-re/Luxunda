...
from .communication_gene import CommunicationGene
from .database_gene import DatabaseGene
from .embedding_gene import EmbeddingGene
...
class GeneRegistry:
    ...
    def initialize_registry(cls):
        cls.register_gene('communication', CommunicationGene)
        cls.register_gene('database', DatabaseGene)
        cls.register_gene('embedding', EmbeddingGene)